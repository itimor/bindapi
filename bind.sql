# 插入SOA数据
INSERT INTO `dnstable` (`zone`, `host`, `type`, `data`, `ttl`,`mx_priority`,
...
# 插入@ NS数据
INSERT INTO `dnstable` (`zone`, `host`, `type`, `data`) VALUES
...
# 插入www A记录
INSERT INTO `dnstable` (`zone`, `host`, `type`, `data`, `ttl`, `view`) VALUES
...
# 插入CNAME 记录
INSERT INTO dnstable (zone,host,type,DATA,view) VALUES
