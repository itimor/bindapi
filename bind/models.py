...
class Record(models.Model):
    ...
    host = models.CharField(max_length=30, verbose_name=u"记录名")
    type = models.CharField(choices=Types.items(), default='A', max_length=10, verbose_name=u"记录类型")
    data = models.CharField(max_length=50, verbose_name=u"记录值")
    ...
    resp_person = models.CharField(max_length=100, verbose_name=u"域名管理者")
    primary_ns = models.CharField(max_length=100, verbose_name=u"主ns")
